    ...
    : PostProcessPass(mpDevice, size)
{
    ...
    this->mpShader = new Shader(kQuadVertexShader, L"RenderPass/ModulateIllumination/ModulateIllumination.hlsl", mpDevice, 7, rtvFormats);
...
void ModulateIllumination::forward(RenderContext* pRenderContext, RenderData& renderData)
{
    ...
    mpCmdList->SetGraphicsRootDescriptorTable(1, gpuHandles.at("gDiffuseRadianceDenoised"));
    mpCmdList->SetGraphicsRootDescriptorTable(2, gpuHandles.at("gSpecularRadianceDenoised"));
