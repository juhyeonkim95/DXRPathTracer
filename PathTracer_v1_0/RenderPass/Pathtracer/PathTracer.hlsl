...
void rayGen()
{
    ...
    gDeltaReflectionRadiance[launchIndex.xy] = float4(deltaReflectionRadiance, 1.0f);
    gDeltaTransmissionRadiance[launchIndex.xy] = float4(deltaTransmissionRadiance, 1.0f);
