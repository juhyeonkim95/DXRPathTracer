...
RWTexture2D<float4> gOutputLDR : register(u0);
RWTexture2D<float3> gOutputHDR : register(u1);
RWTexture2D<float3> gOutputNormal : register(u2);
RWTexture2D<float> gOutputDepth : register(u3);
//RWTexture2D<uint> gOutputGeomID : register(u3);
